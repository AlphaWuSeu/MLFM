...
class Network(nn.Module):
    def __init__(self, config,wavelet_name):
        ...
        ##L4
        self.wavelet_block4 = Block_lite_lite(in_channels = 256, out_channels = 512, is_supplement = False, wavelet_name = wavelet_name)
    ...
    def _forward_conv(self, x):
        ...
        x = self.stage4(x)
        x, Lnext = self.wavelet_block4(Llast = Lnext, original = Lx8, x = x, is_downsample = True)
