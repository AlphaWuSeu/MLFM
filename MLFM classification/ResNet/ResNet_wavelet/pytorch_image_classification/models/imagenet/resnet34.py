...
class Network(nn.Module):
    def __init__(self, config,wavelet_name):
        ...
        self.wavelet_block21 = Block_lite_lite(in_channels = 64, out_channels = 128, is_supplement = True, wavelet_name = wavelet_name)
        self.wavelet_block22 = Block_lite_lite(in_channels = 128, out_channels = 128, is_supplement = True, wavelet_name = wavelet_name)
        self.wavelet_block31 = Block_lite_lite(in_channels = 128, out_channels = 256, is_supplement = True, wavelet_name = wavelet_name)
        self.wavelet_block32 = Block_lite_lite(in_channels = 256, out_channels = 256, is_supplement = True, wavelet_name = wavelet_name)
